...
- Toda a explicação de como foi utilizado esses arquivos está no próprio notebook final [trabalho_final.ipynb](https://github.com/lisbylis/Trabalho_Final_Redes_NR/blob/main/trabalho_final.ipynb) que contem os resultados e discussões.
